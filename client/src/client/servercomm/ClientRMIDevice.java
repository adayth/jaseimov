...
/**
 * A ClientDevice to connect to a RMI service.
 * @author Aday Talavera Hierro <aday.talavera@gmail.com>
 */
public class ClientRMIDevice implements ClientDevice
{  
    private int id;
    private String ip;
    private int port;
