        ...
        implements Observer, ActionListener, PropertyChangeListener
{
     ...
     * @param devInfo A {@link DeviceInfo} that contains a SensorDevice.
     */
    protected SensorVisor(DeviceInfo devInfo)
    {        
        initComponents();
        pack();

        deviceInfo = devInfo;
        updater = devInfo.getUpdater();
        ...
        try
        {
            ...
            Color color = dev.getDeviceType().getColor();
    ...
    public void propertyChange(PropertyChangeEvent evt)
    {
        ...
        if(name.equals(Updater.AUTOUPDATE_VALUE))
        {
    ...
    private void initComponents() {
        ...
        updateButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/client/images/arrow_refresh.png"))); // NOI18N
        ...
        autoUpdateButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/client/images/control_play.png"))); // NOI18N
