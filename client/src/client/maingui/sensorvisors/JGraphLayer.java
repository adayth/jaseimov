...
public class JGraphLayer
{
    ...
    private static class DeviceCell extends DefaultGraphCell
    {
        ...
        public DeviceCell(DeviceInfo dev)
        {
            deviceInfo = dev;            
        }
    ...
    {        
        ...
        GraphConstants.setIcon(background.getAttributes(), new ImageIcon(getClass().getResource("/client/images/logo.png")));
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/client/images/car_background.png"));
     ...
     */
    public void addDeviceCell(DeviceInfo dev)
    {
        // Create Cell
        ...
        GraphConstants.setBackground(cell.getAttributes(), type.getColor());
        GraphConstants.setBorder(cell.getAttributes(), BorderFactory.createLineBorder(type.getColor(), 2));
    ...
    private ImageIcon getDeviceImage(DeviceType type, DevicePosition position)
    {
        ...
        switch(type)
        {
            case ACCELEROMETER_SENSOR:
                icon = new ImageIcon(getClass().getResource("/client/images/accelerometer.png"));
                break;                            
            case SONAR_SENSOR:
                icon = new ImageIcon(getClass().getResource("/client/images/sonar.png"));
                break;
            case IR_SENSOR:
                icon = new ImageIcon(getClass().getResource("/client/images/ir.png"));
                break;
            case ENCODER_SENSOR:
                icon = new ImageIcon(getClass().getResource("/client/images/encoder.png"));
                break;
            case CAMERA_SENSOR:
                icon = new ImageIcon(getClass().getResource("/client/images/webcam.png"));
                break;
            default:
                icon = new ImageIcon(getClass().getResource("/client/images/pencil.png"));
                break;
        }        
        ...
        switch(position)
        {
            ...
            case FRONT_LEFT_CORNER:
                angle = 0;
                icon = new ImageIcon(getClass().getResource("/client/images/sonar_corner.png"));
                break;
