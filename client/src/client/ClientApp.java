...
import client.maingui.MainFrame;
 ...
 * and a {@link DeviceList}. Also creates and shows the GUI in class {@link MainFrame}.
...
public final class ClientApp
{
    ...
    public static void connectServer()
    {
        if(!conected)
        {
            deviceList = new DeviceList(IP,port);
            try
            {
                deviceList.getServiceInfo();
            }
            ...
            conected = true;
            mainFrame.updateUI(conected, deviceList.getDeviceInfoArray());
        }
    }
    ...
    public static void disconnectServer()
    {
        if(conected)
        {
            DeviceInfo[] infoArray =  deviceList.getDeviceInfoArray();
            for(DeviceInfo info : infoArray)
            {
                try
                {
                    if(info.getClient().isConnected())
                    {
    ...
    /**
     * Returns the {@link DeviceList}.
     * @return The current DeviceList of the client.
     */
    ...
    {
        return java.util.ResourceBundle.getBundle("client/client").getString(property);
    }
