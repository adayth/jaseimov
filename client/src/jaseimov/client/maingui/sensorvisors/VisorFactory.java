...
{
  /**
   * Factory method to create a SensorVisor based in the DeviceType of a {@link RemoteDeviceInfo}.
   * @param deviceInfo
   * @return A new SensorVisor.
   */
  public static SensorVisor getSensorVisor(RemoteDeviceInfo deviceInfo)
  {
    try
    {
