...
{    
     ...
     * @param deviceArray An array of {@link RemoteDeviceInfo} that contains Cameras devices.
     */
    public CameraFrame(RemoteDeviceInfo[] deviceArray)
    {
        initComponents();
        // Init GUI        
        ...
        // Setup cameras
        for(RemoteDeviceInfo info : deviceArray)
        {
            try
            {
    ...
    private void addCamera(RemoteDeviceInfo camera, DevicePosition position)
    {
        JPanel panel;        
