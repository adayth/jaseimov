...
/**
 * Command that creates and show a {@link ChartFrame}.
 * @author Aday Talavera Hierro <aday.talavera@gmail.com>
 */
public class MakeChartCommand extends Command
{
    private static final String name = "make chart";

    private ChartFrame chartFrame;

    public MakeChartCommand()
    {
        super(name);
    }
    ...
    public void execute()
    {
        ...
        {            
            ...
            {
                chartFrame = new ChartFrame(sensorList.toArray(new RemoteDeviceInfo[0]));
            }
            ClientApp.registerFrame(chartFrame);
