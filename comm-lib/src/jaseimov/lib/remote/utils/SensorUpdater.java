 ...
 */
package jaseimov.lib.remote.utils;
 ...
 */
public class SensorUpdater extends Observable
{
    /**
     * Default update time for an SensorUpdater.
     */
    ...
    /**
     * Creates an SensorUpdater.
     * @param sensor SensorDevice to be updated.
     */
    public SensorUpdater(SensorDevice sensor)
    {
        this.sensor = sensor;        
        updateTime = SensorUpdater.DEFAULT_UPDATE_TIME;
        autoUpdate = false;

        // Increases camera's performance with a dedicated thread to it
    ...
    /**
     * Adds a new PropertyChangeListener to the SensorUpdater properties.
    ...
    /**
     * Removes a PropertyChangeListener from the SensorUpdater properties.
