...
/**
 * A list of ServiceDevice that allows a server to start/stop all ServiceDevice that contains.
...
{  
    private List<ServiceDevice> list = new ArrayList();
    private int port;
    ...
    /**
     * Allocates this list in RMI registry using ServiceListing RMI interface.
    ...
    /**
     * Unallocates this list in RMI registry.
     * @throws RemoteException
    ...
    /**
     * Add a new ServiceDevice to the list.
    ...
    /**
     * Starts all ServiceDevice contained in this list using {@link ServiceDevice#startService()}.
     * @throws RemoteException
    ...
    /**
     * Stops all ServiceDevice contained in this list using {@link ServiceDevice#stopService()}.
     * @throws RemoteException
     * @throws NotBoundException
     */
    ...
    {        
        ...
        for(ServiceDevice svc : list.toArray(new ServiceDevice[0]))
        {            
    ...
    /**
     * Returns an array that contains all ServiceDevice stored in this list.
     * @return Array of ServiceDevice.
     */
    public ServiceDevice[] getServices()
    {
        return list.toArray(new ServiceDevice[0]);
    }
}